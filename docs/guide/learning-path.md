...
### ステップ1: 基礎固め
1. [施工図の基礎 - 用語集](../shop-drawing/terminology.md)
2. [施工図の基礎 - 図面の種類](../shop-drawing/types.md)
3. [施工図の基礎 - 図面の読み方](../shop-drawing/reading.md)

### ステップ2: BIM概要
1. [施工BIM全体像](../bim/overview.md)
2. [工程別活用マップ](../bim/phase-map.md)
3. [データ連携](../bim/data-exchange.md)

### ステップ3: 実践レシピ
1. [躯体図チェック](../bim/recipes/structure-check.md)
2. [スリーブチェック](../bim/recipes/sleeve-check.md)
3. [鉄筋納まり検討](../bim/recipes/rebar-coordination.md)
4. [鉄骨二次部材調整](../bim/recipes/steel-secondary.md)

### ステップ4: 応用
1. [NG事例集](../ng/index.md)で失敗事例を学ぶ
2. [テンプレート](../templates/index.md)を使って実践
3. 実際のプロジェクトで適用
